...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const starterDetails = {
        ...
        litten: {
            title: "🐱 Litten",
            content: "✓ Il più offensivo. Incineroar (Fuoco/Buio) è un tank fisico con Fuocofuria e Sgranocchio<br>✓ Buona copertura con mosse Fuoco e Buio<br>⚠ Lento<br>⚠ Debole contro Acqua, Terra, Lotta, Roccia<br>⚠ Il tipo Buio aggiunge debolezza a Lotta e Folletto<br><br>✓ Scelta solida, richiede più attenzione"
        },
        rowlet: {
            title: "🦉 Rowlet",
            content: "✓ Il più versatile all'inizio. Decidueye (Erba/Fantasma) ha buon Attacco fisico<br>✓ Mosse di copertura interessanti<br>✗ Statistiche nella media<br>✗ Debole contro Fuoco, Ghiaccio, Volante, Buio, Fantasma<br>✗ Non eccelle in nulla<br><br>⚠ Scelta intermedia - Popplio e Litten offrono più valore in una Nuzlocke"
        }
    };
    ...
    console.log('✨ Nuzlocke Guide Pokémon Sole - Caricata con successo!');
    console.log('🏝️ ZONA SAFARI DI ALOLA è un tesoro! Cattura Gible (Garchomp) e Bagon (Salamence) appena possibile.');
    console.log('💀⚫ MUK DI ALOLA (Grimer al Percorso 6) ha un solo punto debole (Terra). Tank eccellente per la Lega.');
    ...
    console.log('☀️🦁 SOLGALEO è OP! Catturalo durante la storia (Lv.55). Criniera Lucente devastante.');
    console.log('🎮 EXP SHARE globale in 7ª gen! Riduce il grind ma usalo con moderazione.');
    console.log('⚡ MOSSE Z possono essere un punto di svolta. Usale con parsimonia.');
});