/**
 * Nuzlocke Guide - Pokémon Ultrasole
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('✨ Nuzlocke Guide Pokémon Ultrasole - Caricata con successo!');
    ...
    console.log('🪲💪🍃⚔️🎭🔥 ULTRA BESTIE DURANTE LA STORIA! Buzzwole, Kartana e Blacephalon sono OP. Catturali appena possibile.');
    console.log('💀⚫ MUK DI ALOLA (Grimer al Percorso 6) è un tank Buio eccellente per UltraNecrozma.');
    console.log('🌙🐕 UMBREON (Eevee al Percorso 4) con Sgranocchio è un tank perfetto per UltraNecrozma.');
    console.log('🏝️ ZONA SAFARI DI ALOLA contiene tutti i pseudo-leggendari. Garchomp e Salamence sono top tier.');
    console.log('⚙️🧲 MAGNEZONE (Magnemite al Percorso 3) è fondamentale per Kahili (Volante).');
    console.log('🎮 EXP SHARE disponibile. Usalo per ridurre il grind, ma attenzione a non overlivellare troppo presto.');
